...
router.get(
  '/',
  adminAuth,
  requirePermission(PERMISSIONS.BILLBOARD_READ),
  getBillboardController,
);

// Admin — Full CRUD (Super Admin only)
router.put(
  '/',
  adminAuth,
  requirePermission(PERMISSIONS.BILLBOARD_UPDATE),
...
router.post(
  '/carousels',
  adminAuth,
  requirePermission(PERMISSIONS.BILLBOARD_CREATE),
  uploadSingle,
...
router.delete(
  '/carousels/:imgId',
  adminAuth,
  requirePermission(PERMISSIONS.BILLBOARD_DELETE),
